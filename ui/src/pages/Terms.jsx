  ...
  return (
    <StaticPage className="" title="Terms of Service" description={description}>
      <main className="document">
        ...
        <h2>Privacy</h2>
        <p>
          Our <Link to="/privacy-policy">Privacy Policy</Link> describes how we
        ...
        <p>
          ...
          regulations. You should not provide Content that you are uncomfortable
          sharing with others.
        </p>
        <p>
        ...
        <p>
          We reserve the right to remove any Content that may or may not violate
          the Terms of Service at any time.
        </p>
        <p>
          If you believe that your Content has been copied in a way that
          constitutes copyright infringement, please send us an email at{" "}
        ...
        <p>
          ...
          entitled to post the material and to grant {CONFIG.siteName} the
          license described above.
        </p>
        <h2>Limitations of liability</h2>
        <p>
          In no event shall this website or its suppliers and maintainers be
          liable for any damages, including, without limitation, damages for
          loss of data or profit, arising out of the use or inability to use the
          Services, even if we have been notified beforehand the possibility of
          such damage.
        </p>
        <h2>Disclaimer</h2>
        <p>
          The Services of this website are provided "as is". We make no
          ...
          the Services or otherwise relating to such materials or on any sites
          linked to this site.
        </p>
        <h2>General</h2>
