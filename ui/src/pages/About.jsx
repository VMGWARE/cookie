  ...
  const faqItems = [
    {
      ...
      answer: (
        <>
          ...
          <a
            href="https://www.patreon.com/discuit"
            target="_blank"
            rel="noreferrer"
          >
            Patreon
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <Link to="/DiscoApp">Disco</Link> for iOS, and{" "}
          <Link to="/Diskette">Diskette</Link> for Android.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          ...
          or join our <a href={CONFIG.discordURL}>Discord server </a>
      ...
      return (
        ...
        >
          <div
            ...
            onClick={() => setFaqItemOpenedIndex(index)}
          >
            <span>{question}</span>
            <svg
              width="19"
      ...
      <div className="about-landing">
        <div className="wrap">
          ...
          <h2 className="about-subheading">
            Discuit is a non-profit, open-source community discussion platform.
      ...
      <div className="about-rest">
        <div className="wrap">
          <div className="about-section about-mission">
            <p>
              Our mission is to build the first large-scale social media
              platform where the interests of the platform are aligned with the
              interests of the user—a platform, in other words, that’s built on
              principles of ethical design. At the heart of these principles is
              the idea of giving users the freedom to choose their online social
              experience as they would prefer.
            </p>
            <p>
              Social media platforms have hitherto done the opposite and taken
              away what little control the users had, as it served those
              companies’ own self-interest, which was and still remains, to make
              as much money as possible, without any regard for, indeed to the
              utter detriment of, the well-being of the user.
            </p>
            {/*<p>
          ...
          <div className="about-section about-highlights">
            <div className="about-highlight">
              ...
              There are no ads, no forms of affiliate marketing, and no tracking
              anywhere on Discuit. And neither your attention, nor your data, is
              monetized in any way, shape or form.
            </div>
            <div className="about-highlight">
            ...
            <div className="about-highlight">
              ...
              Choice over what appears on your feed. Multiple feeds. A plethora
              of ways to filter content. In short, you have complete control
              over what you see on Discuit. (Please note that Discuit is a work
              in progress and that many of these features are yet to be built.)
            </div>
            <div className="about-highlight">
              <span className="is-bold">No dark patterns.</span>
              On Discuit, there are no nagging popups asking you to sign up. You
              don’t need an account to simply view a page. Images, in their
              highest quality, can be freely downloaded. We don’t manipulate you
              into using our platform more than you desire to.
            </div>
          </div>
