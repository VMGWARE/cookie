...
const Elements = () => {
  ...
  return (
    <div className="test-elements wrap" style={style}>
      ...
      <button type="button" className="button-text button-with-icon">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="far"
      ...
      <button type="button" className="button-icon-simple">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
      ...
      <Dropdown target={<button type="button">Dropdown</button>}>
      ...
      <p>
        ...
        cupiditate, asperiores, quam, ullam id nobis est incidunt dolores velit
        cum saepe quia voluptatem. Obcaecati sunt in ipsam laudantium deleniti.
      </p>
      <p>
        Should this look more like a document or an app? Regardless, it should
        feel hella fast and responsive.
      </p>
      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        <div className="modal-card">
          ...
          <div className="modal-card-content">
            ...
            nulla amet aliquid quidem reiciendis et ad voluptates soluta
            dolorem, illum nesciunt ratione eaque deleniti doloribus illo quam
            ea? Nihil, dolorum?
          </div>
      ...
      <button type="button" onClick={() => dispatch(snackAlert("same thing"))}>
        Snack Alert
      </button>
      <div className="input-with-label">
      ...
      <div className="pagination">
        <div className="left">
          <button type="button" className="pagination-item is-selected">
            1
          </button>
      ...
      <button type="button" className="button-hamburger">
      ...
      <p>
        ...
        aliquam voluptas esse maiores eaque quos earum, non hic saepe vitae
        molestiae nostrum! Dicta illum veniam eius culpa? Pariatur, harum!
      </p>
      <div style={{ width: "100%" }}>
        <PostCardSkeleton />
      </div>
